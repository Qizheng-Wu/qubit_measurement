...
info= {
    ...
    'wave_len'          :100,  #dac输出点数
    'cycle_times'       : 0,   #实验循环次数
    'cycle_period_ns'   :700,   #实验循环周期
...
#打开驱动，连结所有机箱
driver = MmcsDriver(box_ip_dict={'box1':'192.168.4.9','box2':'192.168.4.10'})
...
for name, da in driver.da.items():
    ...
    driver.da_set_level2_trigger_ram(name=name,time_stamp_list_ns=[20,120,320,420],cmd_list=[1,2,1,2])
...
# driver.sys_unlock_all_backplane() #强行停止背板 
