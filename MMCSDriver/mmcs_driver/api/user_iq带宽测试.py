...
#设置输出波形
sdk.dac.SendDacWave(sdk.PCIE_DIO_6, 1, 'square', 1000000, -200, +200, 0)
sdk.dac.SendDacWave(sdk.PCIE_DIO_6, 2, 'square', 1000000, -200, +200, 0)
sdk.dac.SendDacWave(sdk.PCIE_DIO_6, 3, 'square', 1000000, -200, +200, 0)
sdk.dac.SendDacWave(sdk.PCIE_DIO_6, 4, 'square', 1000000, -200, +200, 0)

#设置回传小包间隔为最小
sdk.adc.set_packet_sending_interval(sdk.PCIE_DIO_10, 25)
#设置采样长度
